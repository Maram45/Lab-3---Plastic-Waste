...
ggplot(data = plastic_waste, 
  ...
  geom_violin()
```
Answer : box plots provide a coarser summary of the data , provide more of a summary of a distribution can also be seen an advantage in certain cases. Then Violin plots
...
ggplot(data = plastic_waste,
    ...
    geom_point()
```
Answer:Europe (Positive)relationship , Africa is the most (mismanged _ plastic waste per cap )
...
Answer: gemo_smooth (Aids the eye in seeing patterns in the presence of overplotting also it`s help us to do see the curve of the data and analyis it via a different way )
